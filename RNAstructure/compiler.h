...
#
# The INCLUDEPATH flags are used in the RNAstructure_java_interface Makefile.
#
...
# Set the library compilation command, depending on if compilation is static
# (text interfaces) or shared (Java GUI).
Set_Library_Compilation_Type_Command =
ifneq (${JAVA},yes)
	LIBCOMP = ar rc
else
	LIBCOMP = ${CXX} ${LIBFLAGS} -o
endif
