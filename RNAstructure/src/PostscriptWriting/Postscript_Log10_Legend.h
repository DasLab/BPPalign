...
#ifndef POSTSCRIPT_LOG10_LEGEND_H
#define POSTSCRIPT_LOG10_LEGEND_H

#include "Postscript_RGB_Legend.h"

class Postscript_Log10_Legend : public Postscript_RGB_Legend {
 public:
   ...
   */
  Postscript_Log10_Legend( int entries );

  /*
   * Name:        Destructor
   * Description: Actually has nothing to do, here as a placeholder
   */
  ~Postscript_Log10_Legend();
};

#endif /* POSTSCRIPT_LOG10_LEGEND_H */
