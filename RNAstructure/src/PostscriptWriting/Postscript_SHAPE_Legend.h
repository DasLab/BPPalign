...
#ifndef POSTSCRIPT_SHAPE_LEGEND_H
#define POSTSCRIPT_SHAPE_LEGEND_H

#include "Postscript_Legend.h"

class Postscript_SHAPE_Legend : public Postscript_Legend {
 public:
...
#endif /* POSTSCRIPT_SHAPE_LEGEND_H */
