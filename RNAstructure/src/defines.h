...
#define safiversion 2//version is the save file version for single sequences
#define pfsaveversion 2//this is the version of save file format for partition functions
