...
//! Dynalign-object Class.
/*!
	The Dynalign-object class provides an entry point for the Dynalign algorithm. 
...
class Dynalign_object:  public TwoRNA {
	...
	public:
		...
		int Dynalign(const short int maxtrace, 
			const short int bpwin, const short int awin, const short int percent, const short int imaxseparation=-99, const float gap=0.4, const bool singleinsert=true, 
			...
			const short int numProcessors=1, const int maxpairs=-1,  const short int cycles=2);
