...
class Thermodynamics {
	...
	public:
		...
		//!This function allows the user to specify folding temperatures other than 310.15 (37 degrees C).
		...
		//!When this function is called, the tehrmodynamic parameter files are immediately read from disk.  These include both enthalpy
		...
		//! Public functions that need the thermodynamic parameters call this function. 
		...
		//! This function generates no errors.  (Error checking was done for this during construction).
